...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="frontend/open-iconic-bootstrap.min.css">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="{{ route('root_path') }}" class="nav-link">Home</a></li>
            <li class="nav-item active"><a href="{{ route('shop_path')}}" class="nav-link">shop</a></li>
	          
            <li class="nav-item cta cta-colored"><a href="{{ route('panier_path') }}" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
